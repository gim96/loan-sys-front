...
export default function DeleteModal({openDelete, setOpenDelete, currentItem, handleDelete}) {
  ...
  useEffect(() => {
    ...
    return(
        ...
        <ModalHeader toggle={() => setOpenDelete(false)}>Remove Customer</ModalHeader>
        <ModalBody>
         <CardText>  <ErrorIcon color='danger' /> &nbsp;Are you sure you want to remove this customer?</CardText>
         <Row className='pt-4'>
