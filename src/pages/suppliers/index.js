...
const Expenses = function () {
  ...
  async function getData() {
    ...
    axios.get(`${getSource()}/suppliers?page=1&limit=20`, token_header)
    .then((resp) => {
        console.log(resp);
...
const handleCreate = (data) => {
    ...
    axios.post(`${getSource()}/suppliers/`, data, token_header)
    .then((resp) => {
...
const handleUpdate = (data) => {
    ...
    axios.patch(`${getSource()}/suppliers?id=${currentItem._id}`, data, token_header)
    .then((resp) => {
        getData();
        setOpenEdit(false); 
    })
...
const handleDelete = () => {
    axios.delete(`${getSource()}/suppliers?id=${currentItem._id}`, token_header)
    .then((resp) => {
        getData();
        setOpenDelete(false); 
    })
